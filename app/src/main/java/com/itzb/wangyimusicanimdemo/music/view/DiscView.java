package com.itzb.wangyimusicanimdemo.music.view;
...
import com.itzb.wangyimusicanimdemo.music.BitmapUtil;
import com.itzb.wangyimusicanimdemo.music.ViewPagerAdapter;
...
//        底盘
        ...
        int musicCircleWidth = UIUtils.getInstance(getContext()).getWidth(813);
